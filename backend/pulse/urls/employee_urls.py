...
from pulse.views.employee import EmployeeCreateView, EmployeeDetailView, \
    EmployeeDetailViewAddToCompany, EmployeeListView, EmployeeListViewByCompany, EmployeeDetailViewByJWTTask
...
urlpatterns = [
    ...
    path('/me/<int:task_id>', EmployeeDetailViewByJWTTask.as_view())
]
